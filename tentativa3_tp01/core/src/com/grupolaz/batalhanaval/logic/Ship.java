...
public class Ship {
    ...
    /**
     * <h3>Configura se o navio foi ou não colocado no tabuleiro</h3>
     * 
     * @param isPlaced <p>- recebe o estado do navio.</p>
     */
    ...
    /**
     * <h3>Retorna se o navio foi colocado no tabuleiro.</h3>
     * 
     * @return <p>- true: foi colocado no tabuleiro.</p>
     *         <p>- false: não foi colocado no tabuleiro.</p>
     */
